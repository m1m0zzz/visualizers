...
const midiUrls = [
  "/midi/garden-weeds/BASS.mid",
  "/midi/garden-weeds/TROMBONE.mid",
  "/midi/garden-weeds/HORN.mid",
  "/midi/garden-weeds/CHORD.mid",
  "/midi/garden-weeds/FLUTE.mid",
  "/midi/garden-weeds/ARP.mid",
  "/midi/garden-weeds/TRUMPET.mid",
  "/midi/garden-weeds/MELODY.mid",
]
const drumPadMidiUrl = "/midi/garden-weeds/DRUMS.mid"
const sources = [
  "/audio/garden-weeds/drums.mp3",
  "/audio/garden-weeds/bass.mp3",
  "/audio/garden-weeds/inst.mp3",
  "/audio/garden-weeds/vocals.mp3",
]
const twoMixUrl = "/audio/garden-weeds/2mix.mp3"
...
export function Main() {
  ...
  return (
    <>
      <main className="relative w-[1280px] h-[720px] text-white select-none">
            ...
            <div className="grow shrink flex flex-row gap-8 justify-between">
              ...
              >
                <a
                  ...
                  aria-label="Arnica - Garden Weeds | SoundCloud"
                >
                ...
                <div className="w-full grow flex justify-between">
                  ...
                  <div className="shrink-0 w-[120px] h-[120px] border">
                    <DrumPad midiUrl={drumPadMidiUrl} />
                  </div>
                </div>
              </div>
            </div>
